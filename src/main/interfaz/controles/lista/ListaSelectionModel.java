package main.interfaz.controles.lista;

import javax.swing.DefaultListSelectionModel;
import javax.swing.JList;

public class ListaSelectionModel extends DefaultListSelectionModel
{
    private JList list;
    private int maxCount;

    public ListaSelectionModel(JList list,int maxCount)
    {
        this.list = list;
